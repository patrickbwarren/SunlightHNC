...
\noindent{\bf\large FORTRAN 90 Ornstein-Zernike solver --- version 1.9}\\[6pt]
...
accurate Monte-Carlo simulations are $p=23.65\pm0.01$ and
$e=13.63\pm0.01$, so the HNC virial route result is in error by
$\approx0.5$\%.

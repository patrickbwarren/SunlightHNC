...
\noindent{\bf\large FORTRAN 90 Ornztein-Zernike code - version 1.7}\\[6pt]
...
%
\item Sundry items: \verb+driver*.f90+ and \verb+urpm.f90+ are sample
  FORTRAN 90 driver routines, retained for regression testing
  (\cf\ also \verb+driver3.py+), and \verb+fftw_test.f90+ is test code
  to comprehend how FFTW works.
%
\end{itemize}

...
\item\verb+wsg_fig5_compare.py+ -- calculate the free energy
  difference $\Delta F$ between a system of $N-1$ A particles and a B
  particle, and a pure system of $N$ A particles, as a function of
...
\item\verb+hm_fig10-2_compare.py+ solves the HNC for the RPM and
  generates data that can be compared with Fig 10.2 of \Refcite{HM06}.
...
%
\item Sundry items: \verb+driver2.f90+, \verb+driver3.f90+,
  \verb+driver4.f90+ and \verb+urpm.f90+ are sample FORTRAN 90 driver
  routines, retained for regression testing (\cf\ also
  \verb+driver3.py+), and \verb+fftw_test.f90+ is test code to

...
$A=25$ using the default grid size and spacing, and prints the virial route pressure,
%
\begin{verbatim}
#!/usr/bin/env python3
from oz import wizard as w
...
GP pressure = 23.56441
\end{verbatim}
%
The last here is the (negative) grand potential (GP) density, which in a homogeneous system should equal the pressure; this (numerically) verifies consistency with the virial route.  The pressure calculated by the compressibility route differs by about 4\%
